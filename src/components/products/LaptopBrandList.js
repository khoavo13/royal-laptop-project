...
export default function LaptopBrandList() {
  ...
  const filteredProducts = laptops.filter((product) => product.brand === brand);
    ...
    <Container maxWidth="lg" sx={{ marginTop: "100px" }}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          ...
          >
            <Typography variant="h5">Danh sách máy tính của {brand}</Typography>
            <Select
              value={sortOption}
